    ...
    def __init__(
        ...
        if ext == '.pkl':
            ...
            if self.dataset_name == 'thuman4' or self.dataset_name == 'actorshq' or self.dataset_name == 'avatarrex':
                ...
                smpl_data = dict(smpl_data)
                smpl_data["expression"][:,0]=smpl_data["expression"][:,0]*0.01
                smpl_data["expression"][:,1]=smpl_data["expression"][:,1]*100
                smpl_data["expression"][:,2]=smpl_data["expression"][:,2]*10
                smpl_data["expression"][:,3]=smpl_data["expression"][:,3]*0.100
                smpl_data["expression"][:,4]=smpl_data["expression"][:,4]*500
                smpl_data["expression"][:,5]=smpl_data["expression"][:,5]*10
                smpl_data["left_hand_pose"][:,0]=smpl_data["left_hand_pose"][:,0]*0.01
                smpl_data["left_hand_pose"][:,1]=smpl_data["left_hand_pose"][:,1]*100
                smpl_data["left_hand_pose"][:,2]=smpl_data["left_hand_pose"][:,2]*10
            else:  # AMASS dataset
